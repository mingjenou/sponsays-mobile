...
SponSays makes a decision instead of asking users to browse. The default flow is context → decision → action.
...
No social network, bookings, ads dashboard, points economy, turn-by-turn navigation, broad travel planner or generic marketplace in the initial MVP.
